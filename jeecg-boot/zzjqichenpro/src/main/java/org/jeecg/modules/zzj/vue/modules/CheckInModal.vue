  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'idnumber','name','gender','birthday','national','idaddress','phonenum','roomnum','truecreatetime','trueupdatetime','orderid','preday','isflag','pdfname','imgurl'))
		  //时间格式化
        });
