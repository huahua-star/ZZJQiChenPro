...
public class AlipayUtil {
    ...
    /*public void test_monitor_schedule_logic() {
        ...
        // 测试当面付2.0查询订单
        public static Boolean trade_query(String outTradeNo) {
        ...
        // 测试当面付2.0生成支付二维码
        public static Map trade_precreate(String dir,String amount,String roomNum,String roomName) {
            ...
            String body = "支付房费"+totalAmount+"元";
            ...
            // 商品明细列表，需填写购买商品详细信息，
            List<GoodsDetail> goodsDetailList = new ArrayList<GoodsDetail>();
            Double money = Double.valueOf(amount)*100;
            // 创建一个商品信息，参数含义分别为商品id（使用国标）、名称、单价（单位为分）、数量，如果需要添加商品类别，详见GoodsDetail
            GoodsDetail goods1 = GoodsDetail.newInstance(roomName, roomNum, money.intValue(), 1);
            // 创建好一个商品后添加至商品明细列表
            goodsDetailList.add(goods1);
            ...
            switch (result.getTradeStatus()) {
                case SUCCESS:
                    ...
                    String filePath = String.format(dir+"/qr-%s.png",
