<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('离店退房')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <checkout-modal ref="modalForm" @ok="modalFormOk"></checkout-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/zzj/checkout/list",
          delete: "/zzj/checkout/delete",
          deleteBatch: "/zzj/checkout/deleteBatch",
          exportXlsUrl: "zzj/checkout/exportXls",
          importExcelUrl: "zzj/checkout/importExcel",
       },
    }
  },
  computed: {
